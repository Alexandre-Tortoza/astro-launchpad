...
export function runCommand(command: string, arguments_: string[], cwd: string): Promise<number> {
...
export function installCommand(packageManager: PackageManager): { command: string; arguments: string[] } {
