...
- Evaluate additional distribution channels only after npm usage validates the need.
- Consider standalone binaries, Homebrew, checksums, and signatures when there is a supported release process for them.
